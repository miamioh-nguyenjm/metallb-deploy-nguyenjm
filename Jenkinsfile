pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-nguyenjm/metallb-deploy-nguyenjm'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('nguyenjm-225')   // <---- Change this to match your kubernetes cluster credentials
    }
